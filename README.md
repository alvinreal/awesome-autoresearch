...
- [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) - Self-evolving multi-agent orchestrator. Agents develop the orchestrator itself — reads codebase, plans improvements, executes them autonomously.
